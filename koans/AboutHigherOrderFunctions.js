...
describe("About Higher Order Functions", function () {
  ...
  it("should use chain() ... .value() to use multiple higher order functions", function() {
      var result = _([ [0, 1], 2 ]).chain()
                       .flatten()//returns an array of [0, 1, 2]
                       .map(function(x) { return x+1 } ) //returns another array with [1, 2, 3]
                       .reduce(function (sum, x) { return sum + x }) //reduces array to single value 6
                       .value();
